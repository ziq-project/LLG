...
#step
.click the Deadwood Ritual Totem##20741
.accept Deadwood Ritual Totem##8470
.only itemcount(20741) > 0
...
.condition itemcount(21377) < 5 >>Turn In All of Your Deadwood Headdress Feathers
...
.condition rep('Timbermaw Hold') >= Revered >>Reach Revered Reputation with the Timbermaw Hold Faction
>>You can find more around:
...
.goto Winterspring,27.74,34.50
.condition rep("Timbermaw Hold") >= Exalted >>Reach Exalted Reputation with the Timbermaw Hold Faction
]])
