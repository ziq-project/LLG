...
#key wintersaber_trainers_alliance
#faction Alliance
#category reputation
...
.only repval('Wintersaber and Trainers','Neutral') < 1500
...
#step
.condition repval('Wintersaber Trainers','Neutral') < 1500 |or >>Routing Guide
.condition repval('Wintersaber Trainers','Neutral') >= 1500 |or >>Routing Guide
...
.only rep('Wintersaber and Trainers') < Exalted
...
.goto Winterspring,49.94,9.84
.accept Winterfall Intrusion##5201 |or
...
>>only rep("Timbermaw and Hold") < Exalted :: Save any {o}Winterfall Prayer Beads{} you find, to turn in later for {o}Timbermaw Hold{} reputation.
.goto Winterspring,49.94,9.84
.accept Rampaging Giants##5981 |or
...
#step
.condition rep('Wintersaber Trainers') < Exalted |or >>Routing Guide
.condition rep('Wintersaber Trainers') == Exalted |or >>Routing Guide
...
>>On top of the huge rock.
.goto Winterspring,49.94,9.84
.kill 1 Reins of the Winterspring Frostsaber##13086
]])
