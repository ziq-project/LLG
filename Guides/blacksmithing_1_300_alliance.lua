...
.click Here to Collect Materials as You Level or Resume Leveling Blacksmithing
>>'

#step
.click ore as you follow the path around this area
>>Track them on your minimap with "Find Minerals".
.collect Rough Stone,150
...
>>Reach Skill 30 in Blacksmithing
...
>>Reach Skill 65 in Blacksmithing
...
>>Reach Skill 75 in Blacksmithing
...
#step
>>Open Your Blacksmithing Crafting Panel:
.collect Coarse Grinding Stone,30
>>'
...
>>Reach Skill 90 in Blacksmithing
...
.goto Ironforge,52.36,42.55
>>Reach Skill 100 in Blacksmithing
...
#step
.collect Rough Grinding Stone,10
...
>>Inside the building.
.goto Ironforge,52.36,42.55
>>Reach Skill 105 in Blacksmithing
...
>>Stand next to an anvil.
.goto Ironforge,52.36,42.55
>>Reach Skill 110 in Blacksmithing
...
>>Stand next to an anvil.
.goto Ironforge,52.36,42.55
>>Reach Skill 125 in Blacksmithing
...
#step
>>Open Your Blacksmithing Crafting Panel:
.collect Heavy Grinding Stone,30
>>'
...
>>Save 30 of these, you will need them later.
>>Reach Skill 140 in Blacksmithing
...
.click ore as you follow the path around this area
>>Track them on your minimap with "Find Minerals".
.collect Coarse Grinding Stone,20
>>You created these in a previous step.
>>'
...
>>Stand next to an anvil.
.goto Ironforge,52.36,42.55
>>Reach Skill 150 in Blacksmithing
...
.click ore as you follow the path around this area
>>Track them on your minimap with "Find Minerals".
.collect Coarse Grinding Stone,10
>>You created these in a previous step.
>>'
...
>>Stand next to an anvil.
.goto Ironforge,52.55,41.46
>>Reach Skill 155 in Blacksmithing
...
.click ore as you follow the path around this area
>>Track them on your minimap with "Find Minerals".
.collect Heavy Grinding Stone,10
>>You created these in a previous step.
>>'
...
>>Stand next to an anvil.
.goto Ironforge,52.55,41.46
>>Reach Skill 165 in Blacksmithing
...
>>Stand next to an anvil.
.goto Ironforge,52.55,41.46
>>Reach Skill 190 in Blacksmithing
...
>>Buy them from a General Trade Supplier.
>>Smelt the ores into bars at a forge.
.collect Steel Bar,50
>>only not selfmade :: Create them with Mining or purchase them from the auction house.
>>only selfmade :: Create them with Mining.
>>'

#step
.collect Heavy Grinding Stone,20
>>You created these in a previous step.
>>'
...
.goto Ironforge,52.55,41.46
>>Reach Skill 200 in Blacksmithing
...
.collect Solid Grinding Stone,130
>>'
...
>>Reach Skill 210 in Blacksmithing
...
>>Stand next to an anvil.
.goto Ironforge,52.55,41.46
>>Reach Skill 225 in Blacksmithing
...
>>Buy them from a General Trade Supplier.
>>Smelt the ores into bars at a forge.
.collect Steel Bar,140
>>only not selfmade :: Create them with Mining or purchase them from the auction house.
>>only selfmade :: Create them with Mining.
>>'

#step
.collect Solid Grinding Stone,10
>>only not selfmade :: Farm them with Mining or purchase them from the auction house.
>>only selfmade :: Farm them with Mining.
>>'
...
>>Reach Skill 235 in Blacksmithing

#step
.collect Plans: Mithril Spurs,1
>>only not selfmade :: Purchase this from the auction house.
>>'

#step
.click the Plans: Mithril Spurs
.train
...
>>Smelt the ores into bars at a forge.
.collect Mithril Bar,80
>>only not selfmade :: Create them with Mining or purchase them from the auction house.
>>only selfmade :: Create them with Mining.
>>'

#step
.collect Solid Grinding Stone,60
>>You created these in a previous step.
>>'
...
.goto Ironforge,52.55,41.46
>>Reach Skill 250 in Blacksmithing
...
>>Reach Skill 260 in Blacksmithing
...
>>Solid Grinding Stones require four Solid Stone.
.goto Ironforge,52.55,41.46
>>Reach Skill 270 in Blacksmithing
...
#step
.click the Plans: Imperial Plate Bracers
.train

#step
.collect Thorium Bar,520
>>You collected these in a previous step.
>>'
...
.goto Ironforge,52.55,41.46
>>Reach Skill 295 in Blacksmithing
...
#step
.click the Plans: Imperial Plate Boots
.train

#step
.collect Thorium Bar,170
>>You collected these in a previous step.
>>'
...
>>Reach Skill 300 in Blacksmithing
