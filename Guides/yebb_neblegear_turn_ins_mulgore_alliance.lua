...
LLG.RegisterGuide([[
#guide Yebb Neblegear Turn-Ins (Mulgore)
#key yebb_neblegear_turn_ins_mulgore_alliance
#faction Alliance
#category events


#step
.kill 1 Savannah enemies around this area
...
#step
.kill 1 Ashenvale Bear enemies around this area
>>You can find them all over between Raynewood Retreat and Splintertree post.
>>You can also find them east of Satyrn.
...
#step
.kill 1 Crag Coyote enemies around this area
>>You can find the all over central and western Badlands.
...
#step
.kill 1 Stonelash enemies around this area
...
>>Each turnin requires 10 Glowing Scorpid Blood and grants 100 reputation with the Darkmoon Faire.
]])
