...
local enUS = {
    ...
    TIP_STEP_SKIP = "Right click: skip the step",
    TIP_STEP_UNSKIP = "Right click: take the skip back",
}
...
local deDE = {
    ...
    TIP_STEP_SKIP = "Rechtsklick: Schritt ueberspringen",
    TIP_STEP_UNSKIP = "Rechtsklick: Ueberspringen zuruecknehmen",
}
